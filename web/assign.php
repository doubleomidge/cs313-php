    ...
    <header>
        <div class="jumbotron j-assign">
            <div class="intro-assign">
                ...
                <p class="lead">These are just some of my projects, specifically for Web Engineering II, but if you want more then you can
                    check out
    ...
    <div class="row main-assign">
        <div class="col project recent1">
            <div class="pro-content">
                ...
                <p>The homepage and setup for this site was the first step to diving deeper into web development.</p>
