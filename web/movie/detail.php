        ...
        ?>
            ...
            <form action="../index.php?action=modifyData" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-lg" id="movie_title" type="text" <?php if (isset($movieInfo[
                        'movie_title'])) { echo "value='$movieInfo[movie_title]'"; } ?> name="movie_title" required>
                </div>
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="movie_year" type="number" name="movie_year" <?php if (isset($movieInfo[ 'movie_year'])) {
                            echo "value='$movieInfo[movie_year]'"; } ?> required>
                    ...
                    <div class="form-group col-xs-6">
                        ...
                        <input class="form-control" name="movie_run" id="run_time" placeholder="Run time" type="number" <?php if (isset($movieInfo[
                            'movie_runtime'])) { echo "value='$movieInfo[movie_runtime]'"; } ?> required>
                    </div>
                </div>

                <div class="d-flex justify-space-around">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="movieCheck" name="movie_bool" <?php if (isset($movieInfo[ 'movie_yn']))
                            { echo checked; } ?> >
                        <label class="form-check-label" for="movieCheck">Is this a movie?</label>
                    </div>

                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="digital" name="digital_bool" <?php if (isset($movieInfo[
                            'movie_digital'])) { echo checked; } ?> >
